...
//! HOSTNAME: `syed-Inspiron-15-3567`, CPU: `Intel(R) Core(TM) i3-7020U CPU @ 2.30GHz`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn add_item() -> Weight {
		Weight::from_ref_time(1_383_274_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: PeaqStorage ItemStore (r:1 w:1)
	fn update_item() -> Weight {
		Weight::from_ref_time(1_419_007_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: PeaqStorage ItemStore (r:1 w:0)
	fn get_item() -> Weight {
		Weight::from_ref_time(1_549_035_000 as u64)
			.saturating_add(T::DbWeight::get().reads(1 as u64))
	}
}
